...
MODEL_DIR = "./east_icdar2015_resnet_v1_50_rbox/"
...
def freeze_graph(model_folder):
    ...
    output_node_names = "model_0/feature_fusion/concat_3,model_0/feature_fusion/Conv_7/Sigmoid" #原模型输出操作节点的名字
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_folder",default="./east_icdar2015_resnet_v1_50_rbox/", type=str, help="input ckpt model dir") #命令行解析，help是提示符，type是输入的类型，
